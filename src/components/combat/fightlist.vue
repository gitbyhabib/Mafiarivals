      ...
      <div class="fightbg card">
        ...
        <div class="container-fluid Gp0m0">
          <div class="row no-gutters">
            <div class="col-12">
              <h4 class="hr-sect titlefnt text-center">Fight</h4>
            </div>
          ...
          <div class="row Gp0m0 rounded blkd75 p-2">
            ...
            <div class="col-8 px-1">
              ...
              <div class="row Gp0m0">
                ...
                <div class="col-6 pl-2">
                  <h6 class="dtlsfnt siz17">Rank: {{ masrc.cmbtrnk }}</h6>
                </div>
              </div>
            </div>
    ...
    >
      <div class="row Gp0m0 card blkgry">
        <div class="card-header blkgry px-1 py-0">
          <h4 class="rounded-0 text-center py-1 w-100" style="position: sticky">
            Welcome To the flight
            <span class="float-right" style="margin-right: 2%" @click="hidee()"
              ><div class="crossbtn"><i class="fas fa-times"></i></div
            ></span>
          </h4>
        </div>
        <div
          ...
          style="height: 250px; overflow: scroll"
        >
          <h4 class="text-center">You loose with {{ whos }}</h4>
        </div>
      </div>
    </modal>
  ...
  beforeCreate() {
    this.$mgo.gt("/fight/list/2", (rs) => {
      ...
      if (rs.status_code == 200) {
        ...
        this.mbrlst = rs.list;
        this.cnt = rs.cnt;
        console.log("list here", this.mbrlst);
      } else {
        this.msg = rs.msg;
      }
    });
    this.$mgo.gt("/mp/hrtbt", (rs) => {
      ...
      (this.bh.hpst = rs.data.hltst),
        ...
        (this.bh.mysklrnk = rs.data.cmbtrnk),
    ...
    demoV1(mid, key) {
      ...
      if ((this.bh.hpst > 0) & (this.bh.hpst > 0) & (this.bh.hpost > 0)) {
        ...
        if (this.bh.hpst <= 0) {
          ...
          this.$modal.show("fdoneme");
        }
      }

      if ((this.bh.hpost > 0) & (this.bh.hpst > 0)) {
